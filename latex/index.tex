...
~\newline
This code configures the S\+S\+I1 as S\+PI Slave on an ~\newline
T\+M4\+C123G launchpad (E\+K-\/\+T\+M4\+C123\+G\+XL) evaluation board. ~\newline
RX timeout interrupt is configured for S\+S\+I1. ~\newline
Four 16bit words are sent from Z\+C706 F\+P\+GA. ~\newline
...
U\+A\+R\+T0 is used to send information to host at 115200 baud and 8-\/n-\/1 ~\newline
mode. ~\newline
~\newline
...
messages bck to host. They are not required for operation of the S\+S\+I1\+: ~\newline
~\newline
